...
import com.example.taskmanagerassignment.databinding.FragmentCompletedTasksBinding
...
class CompletedTasksFragment : Fragment(), SortBottomSheetFragment.SortSelectionListener {
    ...
    override fun onSortSelected(sortType: SortType) {
        ...
        taskViewModel.completedTasks.value?.let { tasks ->
